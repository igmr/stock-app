...
<x-master>
    ...
    <form action="{{ route('app.cartridge.update', $cartridge) }}" method="POST">
        @csrf
        @method('PUT')
                                        ...
                                        <select class="form-control select2" name="printer" id="printer">
                                            @foreach ($printers as $printer)
                                                <option value="{{ $printer->id }}"
                                                    {{ $cartridge->printer_id == $printer->id ? 'selected' : '' }}>
                                                    {{ $printer->description }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('description') ?? $cartridge->description }}">
                                    </div>
                                    <!-- /.input group -->
                                    @error('description')
                                        <code>{{ $message }}</code>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('model') is-invalid @enderror"
                                            ...
                                            value="{{ old('model') ?? $cartridge->model }}">
                                    </div>
                                    <!-- /.input group -->
                                    @error('model')
                                        <code>{{ $message }}</code>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select2" name="color" id="color">
                                            @foreach ($colors as $color)
                                                <option value="{{ $color }}"
                                                    {{ $cartridge->color == $color ? 'selected' : '' }}>
                                                    {{ $color }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select class="form-control select2" name="brand" id="brand">
                                            @foreach ($brands as $brand)
                                                <option value="{{ $brand->id }}"
                                                    {{ $cartridge->brand_id == $brand->id ? 'selected' : '' }}>
                                                    {{ $brand->description }}
                                                </option>
                                            @endforeach
                                        </select>
