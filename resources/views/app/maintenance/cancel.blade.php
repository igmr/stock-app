...
<x-master>
    ...
    <form action="{{ route('app.maintenance.cancel_action', $maintenance) }}" method="POST">
        @csrf
        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="observation" class="form-control @error('observation') is-invalid @enderror" rows="3"
                                            name="observation" placeholder="Subject cancel maintenance">{{ old('observation') }}</textarea>
                                    </div>
                                    <!-- /.input group -->
                                    @error('observation')
                                        <code>{{ $message }}</code>
